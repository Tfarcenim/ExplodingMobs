...
public abstract class UniversalSwirlLayer <T extends Entity, M extends EntityModel<T>> extends RenderLayer<T, M> {

        public UniversalSwirlLayer(RenderLayerParent<T, M> renderLayerParent) {
            super(renderLayerParent);
        }

        public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, T entity, float f, float g, float h, float j, float k, float l) {
            if (/*((PowerableMob)entity).isPowered()*/true) {
